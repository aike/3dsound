...
var ThreePiece = function(id, w, h, useDirtyFlag) {
	...
	this.macro = {
		...
		'ground':{obj: 'plane', w:1000, h:1000, y:-1, rx:Math.PI / -2, col:0xffffff}
	}
...
ThreePiece.prototype.Bloom = function(o) {
	o.w = this.set(o.w, 0.5);
	o.segments = this.set(o.segments, 32);
	o = this.setDefault(o);

	o.c = this.set(o.c, 0.3);
	o.p = this.set(o.p, 2);

	o.camerax = this.set(o.camerax, 0);
	o.cameray = this.set(o.cameray, 2.6);
	o.cameraz = this.set(o.cameraz, 2.6);
	...
	var material = new THREE.ShaderMaterial( 
	{
		...
		{ 
			"c":   { type: "f", value: o.c },
			"p":   { type: "f", value: o.p }, // 2-1.2
			glowColor: { type: "c", value: new THREE.Color(o.col) },
			viewVector: { type: "v3", value: new THREE.Vector3(o.x - o.camerax, o.y - o.cameray, o.z - o.cameraz) }
		},
